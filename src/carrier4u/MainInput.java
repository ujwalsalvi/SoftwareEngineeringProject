...
public final class MainInput extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField1.setText("Press Analyze");
        ...
        jTextField2.setText("Press Analyze");

        jTextField3.setText("Press Analyze");

        jLabel6.setText("T-Mobile Total Points");

        jLabel7.setText("T-Mobile Total Points");

        jLabel8.setText("Verizon Total Points");

        jLabel10.setText("Sprint Total Points");

        jTextField4.setText("Press Analyze");
    ...
    private void AnalysisOfCarriersActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AnalysisOfCarriersActionPerformed
        ...
        jTextField1.setText(String.valueOf(Verizon));
        jTextField2.setText(String.valueOf(Tmobile));
        jTextField3.setText(String.valueOf(Att));
        jTextField4.setText(String.valueOf(Sprint));
